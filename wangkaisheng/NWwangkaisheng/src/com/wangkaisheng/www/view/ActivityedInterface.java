...
import com.wangkaisheng.www.controller.Impl.ActivityedinterfaceImpl;
import com.wangkaisheng.www.controller.Impl.ActivityinterfaceImpl;
 ...
 */
public class ActivityedInterface {
    private final JFrame frame = new JFrame("所有活动");
    ...
    private final Activityedinterface activityedinterface = new ActivityedinterfaceImpl();
    ...
    public ActivityedInterface(Organizer organizer) {
        final JPanel panel = new JPanel();
        frame.setSize(450, 450);
        frame.setLocationRelativeTo(null);
        AllActivity allActivity = activityedinterface.findMyActivity(organizer);
        ...
        quaryActivity.addActionListener(actionEvent -> {
            ...
            activity.setActivity_oid(organizer.getId());
            AllActivity allActivity1 = activityedinterface.findActivity(activity);
        ...
        seeActivity.addActionListener(actionEvent -> {
            ...
            Activity activity1 =  activityedinterface.getAllActivity(allActivity,activity);
            if(activity1!=null){
            ...
            if(flag){
                new SeeActivityInterface(organizer,activity1);
            }else{
