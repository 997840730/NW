...
import com.wangkaisheng.www.controller.Impl.AddpicturesImpl;
...
public class Addpicture {
    ...
    public Addpicture(Organizer organizer) {
        ...
        addPicture.addActionListener(actionEvent -> {
            ...
            if(file.isDirectory()||file.isFile()){
                if (addpictures.addpicture(organizer,file.getAbsolutePath())){
