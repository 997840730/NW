...
import com.wangkaisheng.www.controller.Impl.ActivityinginterfaceImpl;
 ...
 */
public class ActivityingInterface {
    ...
    private final Activityinginterface activityinginterface = new ActivityinginterfaceImpl();
    ...
    public ActivityingInterface(Organizer organizer) {
        final JPanel panel = new JPanel();
        frame.setSize(450, 450);
        frame.setLocationRelativeTo(null);
        AllActivity allActivity = activityinginterface.findMyActivitying(organizer);
        ...
        quaryActivity.addActionListener(actionEvent -> {
            ...
            AllActivity allActivity1 = activityinginterface.findActivitying(activity);
        ...
        seeActivity.addActionListener(actionEvent -> {
            ...
            Activity activity1 =  activityinginterface.getAllActivitying(allActivity,activity);
            if(activity1!=null){
            ...
            if(flag){
                new SeeActivityInterface(organizer,activity1,true);
            }else{
