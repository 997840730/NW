...
public class ActivityInterface {
    ...
    private final Activityinterface activityinterface = new ActivityinterfaceImpl();
    ...
    public ActivityInterface(User user) {
        final JPanel panel = new JPanel();
        frame.setSize(450, 450);
        frame.setLocationRelativeTo(null);
        AllActivity allActivity = activityinterface.findAllActivity() ;
        ...
        quaryActivity.addActionListener(actionEvent -> {
            ...
            AllActivity allActivity1 = activityinterface.findActivity(activity);
        ...
        seeActivity.addActionListener(actionEvent -> {
            ...
            Activity activity1 =  activityinterface.getAllActivity(allActivity,activity);
            if(activity1!=null){
            ...
            if(flag){
                new SeeActivityInterface(user,activity1);
            }else{
