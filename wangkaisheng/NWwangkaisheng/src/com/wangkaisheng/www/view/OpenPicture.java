...
import com.wangkaisheng.www.controller.Impl.OpenpictureImpl;
...
public class OpenPicture {
    ...
    private final Openpicture openpicture = new OpenpictureImpl();
    ...
    public OpenPicture(Activity activity) {
        final JPanel panel = new JPanel();
        frame.setSize(450, 450);
        frame.setLocationRelativeTo(null);
        placeComponents(panel,openpicture.findPictures(activity));
        //在屏幕中居中显示
        frame.add(panel);
        // 添加面板
